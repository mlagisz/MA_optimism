...
calc_d_latency <- function(data, Worse, WorseSD, WorseN, Better, BetterSD, BetterN, WithinBetween, adjusted=TRUE, type=c("lnorm", "delta")){
...
# TEST USE
str(dat_lat) 
calc_d_latency(dat_lat, Worse, WorseSD, WorseN, Better, BetterSD, BetterN, WithinBetween, adjusted=TRUE, type=c("lnorm"))
calc_d_latency(dat_lat, Worse, WorseSD, WorseN, Better, BetterSD, BetterN, WithinBetween, adjusted=FALSE, type=c("lnorm"))
calc_d_latency(dat_lat, Worse, WorseSD, WorseN, Better, BetterSD, BetterN, WithinBetween, type=c("delta"))
calc_d_latency(dat_lat, Worse, WorseSD, WorseN, Better, BetterSD, BetterN, WithinBetween, type=c("lnorm"))
calc_d_latency(dat_lat, Worse, WorseSD, WorseN, Better, BetterSD, BetterN, WithinBetween, adjusted=FALSE)
calc_d_latency(dat_lat, Worse, WorseSD, WorseN, Better, BetterSD, BetterN, WithinBetween)

  pacman::p_load(tidyverse, magrittr)
  testdf <- dat_lat
  str(testdf) 
  testdf %<>% calc_d_latency(Worse, WorseSD, WorseN, Better, BetterSD, BetterN, WithinBetween)
  str(testdf) 
