...
calc.I2(dat$Vd, MA_all_random_VCV_phylo) #77.3% Htotal, 5.1% phylogeny, 0% speciesID
...
MA_all <- rma.mv(yi=d, V=VCV, 
                             ...
                             data = dat, method = "REML") 
summary(MA_all)    
calc.I2(dat$Vd, MA_all) #77.3% Htotal, 5.1% phylogeny
...
```{r Ma all data - sensitivity tests}
...
MR_all_species <- rma.mv(yi=d, V=VCV, 
                     ...
                     dat=dat, method="REML") 
summary(MR_all_species) # some species with clear effect, when phylogeny not taken into account
save(MR_all_species, file = "Rdata/MR_all_species2.Rdata")
```
...
MR_all_CueTypeCat2 <- rma.mv(yi=d, V=VCV, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     dat=dat, method="REML") 
summary(MR_all_CueTypeCat2) # no signif diff to visual
...
MR_all_CueTypeCat3 <- rma.mv(yi=d, V=VCV, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     dat=dat, method="REML") 
summary(MR_all_CueTypeCat3) # no signif diff to visual
...
MR_all_CueTypeCat4 <- rma.mv(yi=d, V=VCV, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     dat=dat, method="REML") 
summary(MR_all_CueTypeCat4) # no signif diff to visual
...
summary(MR_all_Full_1_robust) #same patter as in the original model
...
summary(MR_all_Full_2_robust) #same patter as in the original model
...
summary(MR_all_Full_3_robust) #same patter as in the original model
...
summary(MR_all_Full_4_robust) #same patter as in the original model
...
summary(MR_all_Full_2i_robust) #same patter as in the original model
...
summary(MR_all_Full_1x_robust) #same patter as in the original model
