...
## prepare species correlation matrix - all data
...
calc.I2(dat$Vd, MA_all_random) #80.6% total
...
calc.I2(dat$Vd, MA_all_random_VCV) #80.1% Htotal
...
MA_all_random_VCV_phylo <- rma.mv(yi=d, V=VCV, 
                             ...
                             data = dat, method = "REML") 
summary(MA_all_random_VCV_phylo) ### estimate  ns 0.2187  CI  -0.0623  0.4997   
calc.I2(dat$Vd, MA_all_random_VCV_phylo) #80.9% Htotal, 3.2% phylogeny, 0% species ID
...
MA_all <- rma.mv(yi=d, V=VCV, 
                             ...
                             R = list(Species_Latin = CorMatrix_all),
                             data = dat, method = "REML") 
summary(MA_all) ### much lower ns estimate     
calc.I2(dat$Vd, MA_all) #80.9% Htotal
...
MR_all_sex <- rma.mv(yi=d, V=VCV, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     dat=dat, method="REML") 
summary(MR_all_sex) # signif intc for males, signif diff female-male
...
MR_all_ComparisonCategory1 <- rma.mv(yi=d, V=VCV, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     dat=dat, method="REML") 
summary(MR_all_ComparisonCategory1) # no signif intc Benign-Worse / Better-Benign / Better-Benign
...
MR_all_CueTypeCat1 <- rma.mv(yi=d, V=VCV, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     dat=dat, method="REML") 
summary(MR_all_CueTypeCat1) # signif ittc for auditory
...
MR_all_CueTypeCat <- rma.mv(yi=d, V=VCV, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     dat=dat, method="REML") 
summary(MR_all_CueTypeCat) # no signif diff to auditory
...
save(MR_all_WithinBetween1, file = "Rdata/MR_all_MR_all_WithinBetween1.Rdata")
...
MR_all_MeasureType <- rma.mv(yi=d, V=VCV, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     dat=dat, method="REML") 
summary(MR_all_MeasureType) # signif diff proportion / latency
...
MR_all_ReinforcementCat1 <- rma.mv(yi=d, V=VCV, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     dat=dat, method="REML") 
summary(MR_all_ReinforcementCat1) # no signif intc 
...
MR_all_ReinforcementCat <- rma.mv(yi=d, V=VCV, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     dat=dat, method="REML") 
summary(MR_all_ReinforcementCat) # no signif diff R-Null /  R-R / R-P
...
MR_all_Full_0 <- rma.mv(yi=d, V=VCV, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     dat=dat, method="REML") 
summary(MR_all_Full_0) # all ns
save(MR_all_Full_0, file = "Rdata/RdataMR_all_Full_0.Rdata")
...
MR_all_Full_1 <- rma.mv(yi=d, V=VCV, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     dat=dat, method="REML") 
summary(MR_all_Full_1) # signif itc for male at latency and diff from proportion
save(MR_all_Full_1, file = "Rdata/RdataMR_all_Full_1.Rdata")
...
MR_all_Full_2 <- rma.mv(yi=d, V=VCV, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     dat=dat, method="REML") 
summary(MR_all_Full_2) # sex female and latency diff from male and proportion
save(MR_all_Full_2, file = "Rdata/RdataMR_all_Full_2.Rdata")
...
MR_all_Full_2i <- rma.mv(yi=d, V=VCV, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     dat=dat, method="REML") 
summary(MR_all_Full_2i) # ns interaction
save(MR_all_Full_2i, file = "Rdata/RdataMR_all_Full_2i.Rdata")
     
#ref level male and proportion
MR_all_Full_3 <- rma.mv(yi=d, V=VCV, 
                     mod = ~relevel(dat$Sex, ref="male") + relevel(dat$MeasureType, ref="proportion"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_all), 
                     dat=dat, method="REML") 
summary(MR_all_Full_3) # 
save(MR_all_Full_3, file = "Rdata/RdataMR_all_Full_3.Rdata")
```
...
MA_prop <- rma.mv(yi=d, V=VCV_prop, 
                             random=list(~1|Species_Latin, ~1|ScientificName, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             R = list(Species_Latin = CorMatrix_prop),
                             data = dat_prop, method = "REML") 
...
```{r MR all data - Full, all moderators }
...
calc.I2(dat_lat$Vd, MA_lat_random) #76.1% total
...
calc.I2(dat_lat$Vd, MA_lat_random_VCV) #84.8% Htotal
...
MA_lat_random_VCV_phylo <- rma.mv(yi=d, V=VCV_lat, 
                             ...
                             data = dat_lat, method = "REML")  #NO CONVERGENCE
summary(MA_lat_random_VCV_phylo) ### estimate  ns 0.2187  CI  -0.0623  0.4997   
calc.I2(dat_lat$Vd, MA_lat_random_VCV_phylo) #85.0% Htotal, 3.2% phylogeny, 0% species ID
...
MA_lat <- rma.mv(yi=d, V=VCV_lat, 
                             ...
                             R = list(Species_Latin = CorMatrix_lat),
                             data = dat_lat, method = "REML")  
summary(MA_lat) ### much lower ns estimate     
calc.I2(dat_lat$Vd, MA_lat) #76.2% Htotal
...
```{r funnel plot}
##################### PLOT - funnel plots ##################### 
pdf(file="plots/Fig_funnels_20180701.pdf",width=7,height=3,pointsize=14)
par(mfrow=c(1,3))
par(mar=c(4,4,4,1))
...
```{r test contrasts}
library(multcomp)
res_lat_prop <- rma.mv(yi=Hd, V=HdVar, mod = ~Sex-1, random=list(~1|ArticleID), dat=dat, method="REML") 
...
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$Sex, ref="male"), random=list(~1|ArticleID), dat=dat, method="REML") #male-female Signif -->
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$Sex, ref="female"), random=list(~1|ArticleID), dat=dat, method="REML") #male-female Signif -->
<!-- ######## random-effect model with Sex as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~Sex -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
...
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$Age, ref="adult"), random=list(~1|ArticleID), dat=dat, method="REML") #no diff -->
<!-- ######## random-effect model with Age as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~Age -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
...
<!-- rma.mv(yi=d, V=Vd, mod = ~Captive_Wild.caught, random=list(~1|ArticleID), dat=dat, method="REML")  #no diff -->
<!-- ######## random-effect model with Captive_Wild.caught as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~Captive_Wild.caught -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
...
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$AffectManipCat, ref="stress"), random=list(~1|ArticleID), dat=dat, method="REML")  #no diff -->
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$AffectManipCat, ref="enrichment"), random=list(~1|ArticleID), dat=dat, method="REML")  #no diff -->
<!-- ######## random-effect model with AffectManipCat as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~AffectManipCat -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
...
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$ComparisonCategory, ref="Benign-Worse"), random=list(~1|ArticleID), dat=dat, method="REML")  #no diff -->
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$ComparisonCategory, ref="Better-Benign"), random=list(~1|ArticleID), dat=dat, method="REML")  #no diff -->
<!-- ######## random-effect model with ComparisonCategory as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~ComparisonCategory, random=list(~1|ArticleID), dat=dat, method="REML")  -->
...
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$AffectManipTiming, ref="before"), random=list(~1|ArticleID), dat=dat, method="REML")  #no diff -->
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$AffectManipTiming, ref="during"), random=list(~1|ArticleID), dat=dat, method="REML")  #no diff -->
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$AffectManipTiming, ref="long-term"), random=list(~1|ArticleID), dat=dat, method="REML")  #no diff -->
<!-- ######## random-effect model with AffectManipTiming as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~AffectManipTiming -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
...
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$CueTypeCat, ref="auditory"), random=list(~1|ArticleID), dat=dat, method="REML")  #auditory diff from spatial, visual -->
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$CueTypeCat, ref="olfactory"), random=list(~1|ArticleID), dat=dat, method="REML")  #no diff -->
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$CueTypeCat, ref="spatial"), random=list(~1|ArticleID), dat=dat, method="REML")  #spatial-auditory diff -->
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$CueTypeCat, ref="tactile"), random=list(~1|ArticleID), dat=dat, method="REML")  #no diff -->
<!-- ######## random-effect model with CueTypeCat as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~CueTypeCat -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
...
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$FoodDeprived, ref="yes"), random=list(~1|ArticleID), dat=dat, method="REML") #no diff -->
<!-- ######## random-effect model with FoodDeprived as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~FoodDeprived -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
...
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$TaskType, ref="active choice"), random=list(~1|ArticleID), dat=dat, method="REML")  # diff -->
<!-- ######## random-effect model with TaskType as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~TaskType -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
...
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$StudyDesign, ref="within (before-after)"), random=list(~1|ArticleID), dat=dat, method="REML") #all diff from within (before-after) -->
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$StudyDesign, ref="within (crossover)"), random=list(~1|ArticleID), dat=dat, method="REML") #crossover diff from before-after -->
<!-- ######## random-effect model with Randomized_WithinBetween as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~StudyDesign -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
...
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$Automated, ref="no"), random=list(~1|ArticleID), dat=dat, method="REML")  #no diff -->
<!-- ######## random-effect model with Automated as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~Automated -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
...
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$Blind, ref="no"), random=list(~1|ArticleID), dat=dat, method="REML")  #no diff -->
<!-- ######## random-effect model with Blind as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~Blind -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
<!-- summary(res_lat_prop) #no - Signif -->
<!-- res <- rbind(res, data.frame(Model=NA, M=NA, CI.lb=NA, CI.ub=NA, pch=NA, k.Var1=NA, k.Freq=NA, cld=NA)) #add empty line to results table -->
...
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$MeasureType, ref="latency"), random=list(~1|ArticleID), dat=dat, method="REML")  #latency - prop diff -->
<!-- ######## random-effect model with MeasureType as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~MeasureType -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
...
<!-- res_lat_prop_phylo_MT <- rma.mv(yi=d, V=VCV, mod = ~MeasureType-1, random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID), R=list(Species_Latin=CorMatrix_all), dat=dat, method="REML")  -->
...
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$ReinforcementCat, ref="R-Null"), random=list(~1|ArticleID), dat=dat, method="REML") #R-Null diff from R-P and R-R -->
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$ReinforcementCat, ref="R-P"), random=list(~1|ArticleID), dat=dat, method="REML") #R-P diff from R-Null  -->
<!-- ######## random-effect model with ReinforcementCat as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~ReinforcementCat -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
...
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$AmbigReinforced, ref="yes"), random=list(~1|ArticleID), dat=dat, method="REML")  #no diff -->
<!-- ######## random-effect model with AmbigReinforced as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~AmbigReinforced -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
<!-- summary(res_lat_prop) #no = Signif -->
<!-- res <- rbind(res, data.frame(Model=NA, M=NA, CI.lb=NA, CI.ub=NA, pch=NA, k.Var1=NA, k.Freq=NA, cld=NA)) #add empty line to results table -->
...
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$ScalePoint, ref="A"), random=list(~1|ArticleID), dat=dat, method="REML") #no diff -->
<!-- rma.mv(yi=d, V=Vd, mod = ~relevel(dat$ScalePoint, ref="B"), random=list(~1|ArticleID), dat=dat, method="REML") #no diff -->
<!-- ######## random-effect model with ScalePoint as a moderator, intercepts: -->
<!-- res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~ScalePoint -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
...
<!-- res_MV <- rma.mv(yi=d, V=Vd, mod = ~ Sex + Captive_Wild.caught + CueTypeCat + StudyDesign + Automated + MeasureType + ReinforcementCat, random=list(~1|ArticleID), dat=dat, method="REML") -->
<!-- summary(res_MV) -->

<!-- #res_MV <- rma.mv(yi=d, V=Vd, mod = ~ relevel(dat$Sex, ref="male") + Captive_Wild.caught + CueTypeCat + relevel(dat$StudyDesign, ref="within (before-after)") + Automated + relevel(dat$MeasureType, ref="proportion") + ReinforcementCat, random=list(~1|ArticleID), dat=dat, method="REML") -->
<!-- #summary(res_MV) -->
...
<!-- #res_full_1 <- rma.mv(yi=d, V=Vd, mod = ~ Sex + relevel(dat$CueTypeCat, ref="spatial") + #relevel(dat$Randomized_WithinBetween, ref="between-subject randomized? (no info)") + Automated +relevel(dat$MeasureType, ref="proportion"), random=list(~1|ArticleID), dat=dat, method="REML")  -->
<!-- #summary(res_full_1) -->


<!-- ######## random-effect model with 2 moderators: -->
<!-- res_MR_int <- rma.mv(yi=d, V=Vd, mod = ~ TaskType + MeasureType, random=list(~1|ArticleID), dat=dat, method="REML")  -->
<!-- summary(res_MR_int) -->

<!-- ######## random-effect model with 2 moderators and interaction: -->
<!-- res_MR_int <- rma.mv(yi=d, V=Vd, mod = ~ TaskType * MeasureType -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
<!-- summary(res_MR_int) -->

<!-- res_MR_int <- rma.mv(yi=d, V=Vd, mod = ~ TaskType * relevel(dat$MeasureType, ref="latency") -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
<!-- summary(res_MR_int) -->

<!-- res_MR_int <- rma.mv(yi=d, V=Vd, mod = ~ TaskType * relevel(dat$MeasureType, ref="proportion") -1, random=list(~1|ArticleID), dat=dat, method="REML")  -->
<!-- summary(res_MR_int) -->

<!-- boxplot(Hd ~ TaskType * MeasureType, dat=dat, varwidth=TRUE) -->
<!-- boxplot(Hd ~ TaskType, dat=dat) -->
<!-- boxplot(Hd ~ MeasureType, dat=dat) -->
<!-- ``` -->
...
par(mfcol=c(1,1)) 
par(mar=c(4,4,2,1))
plot(dat$Hd, sqrt(1/dat$Vd), xlim=c(-6.5,6.5), xlab = "Effect size [Hg]", ylab="Precision [1/SE]", main="")
abline(v=0,lty=3)
dev.off()
```
...
```{r publ bias tests}
######## random-effect model with ArticleID as random effect:
res_MA <- rma.mv(yi=d, V=Vd, random=list(~1|ArticleID), dat=dat, method="REML") 
summary(res_MA) ### estimate  0.1679 CI  0.0550  0.2808  **
