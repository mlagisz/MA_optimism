...
MA_random0 <- rma.mv(yi=d, V=Vd, 
                     random=list(~1|ArticleID, ~1|ExperimentID, ~1|GroupID), 
                     dat=dat, method="REML") 
...
MA_random_species <- rma.mv(yi=d, V=Vd, random=list(~1|ArticleID, ~1|ExperimentID, ~1|Species_Latin), data=dat, method="REML")  
...
calc.I2(dat$Vd, MA_random_species) #81% total
...
res_lat_prop_phylo <- rma.mv(yi=d, V=Vd, random=list(~1|ArticleID, ~1|ExperimentID, ~1|Species_Latin), R=list(Species_Latin=CorMatrix_lat_prop), dat=dat, method="REML") 
...
res_lat_prop <- rma.mv(yi=d, V=Vd, mod = ~ComparisonCategory -1, random=list(~1|ArticleID), dat=dat, method="REML") 
