...
calc.I2(dat$Vd, MA_all_random_VCV_phylo) #77.1% Htotal, 4.8% phylogeny, 0% speciesID
...
MA_all <- rma.mv(yi=d, V=VCV, 
                             ...
                             data = dat, method = "REML") 
summary(MA_all)    
calc.I2(dat$Vd, MA_all) #77.1% Htotal, 4.8% phylogeny
...
MR_all_max_species2 <- rma.mv(yi=d, V=VCV_max, 
                     mod = ~ScientificName -1, 
                     random=list(~1|ArticleID, ~1|ExperimentID, ~1|EffectID), 
                     data = dat_max, method="REML") 
summary(MR_all_max_species2) # some species with clear effect, when phylogeny not taken into account
save(MR_all_max_species2, file = "Rdata/MR_all_max_species2.Rdata")
```
