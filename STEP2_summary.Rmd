...
pdf(file="plots/Fig_boxplot_raw_SeX_MeasureType.pdf",width=10,height=6,pointsize=10)
boxplot(dat$d ~ dat$Sex + dat$MeasureType, ylab="Hg", varwidth=TRUE)
abline(h=0, lty=3)
dev.off()
```
...
plot(dat_horiz$d.x, dat_horiz$d.y) #make it pretty
plot(dat_horiz$d.x, dat_horiz$d.y, col=dat_horiz$ExperimentID) #make it prettier
cor.test(dat_horiz$d.x, dat_horiz$d.y) # Pearson's product-moment correlation = 0.2972285 t = 1.6472, df = 28, p-value = 0.1107 CI -0.07060081  0.59390141
