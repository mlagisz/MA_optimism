...
View(dplyr::filter(dat2, d > 4)) #look at effect sizes > 4 - checked agains papers
View(dplyr::filter(dat2, d < (-4))) #look at effect sizes <  -4 - checked agains papers
```
...
# dat2_ok <- dat2[dat2$ArticleID != "Doyle2011b", ] #sheep long terms stress. Tested 3 times ..habituation? Use day 1?
# dim(dat2_ok)
```
