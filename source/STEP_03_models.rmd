...
######## random-effect model with VCV and phylogeny (Species_Latin)
MA_lat_B_ES <- rma.mv(yi=d, V=VCV_lat_B_ES, 
                             random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             R = list(Species_Latin = CorMatrix_lat),
                             data = dat_lat_B_ES, method = "REML") 
summary(MA_lat_B_ES)    
calc.I2(dat_lat_B_ES$Vd, MA_lat_B_ES)
save(MA_lat_B_ES, file = "Rdata/MA_lat_B_ES.Rdata")

######## random-effect model with VCV and no phylogeny and no species
MA_lat_B_ES_nophylo <- rma.mv(yi=d, V=VCV_lat_B_ES, 
                             random=list(~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             data = dat_lat_B_ES, method = "REML") 
summary(MA_lat_B_ES_nophylo)    
calc.I2(dat_lat_B_ES$Vd, MA_lat_B_ES_nophylo)
save(MA_lat_B_ES_nophylo, file = "Rdata/MA_lat_B_ES_nophylo.Rdata")
```
...
######## random-effect model with VCV and phylogeny (Species_Latin)
MA_prop_B_ES <- rma.mv(yi=d, V=VCV_prop_B_ES, 
                             random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             R = list(Species_Latin = CorMatrix_prop),
                             data = dat_prop_B_ES, method = "REML") 
summary(MA_prop_B_ES)    
calc.I2(dat_prop_B_ES$Vd, MA_prop_B_ES)
save(MA_prop_B_ES, file = "Rdata/MA_prop_B_ES.Rdata")

######## random-effect model with VCV and no phylogeny and no species
MA_prop_B_ES_nophylo <- rma.mv(yi=d, V=VCV_prop_B_ES, 
                             random=list(~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             data = dat_prop_B_ES, method = "REML") 
summary(MA_prop_B_ES_nophylo)    
calc.I2(dat_prop_B_ES$Vd, MA_prop_B_ES_nophylo)
save(MA_prop_B_ES_nophylo, file = "Rdata/MA_prop_B_ES_nophylo.Rdata")
```
...
MR_all_species_max_absES <- rma.mv(yi=d, V=VCV_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     data = dat_max_absES, method="REML") 
summary(MR_all_species_max_absES) # rat signif positive
...
MR_all_MeasureType_max_absES <- rma.mv(yi=d, V=VCV_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     data = dat_max_absES, method="REML") 
summary(MR_all_MeasureType_max_absES) # signif diff proportion / latency
...
MR_all_MeasureType1_max_absES <- rma.mv(yi=d, V=VCV_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     data = dat_max_absES, method="REML") 
summary(MR_all_MeasureType1_max_absES) # ns intc proportion, not latency
...
MR_lat_ComparisonCategory2 <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ComparisonCategory2) # no signif diff Benign-Worse / Better-Benign / Better-Benign
...
MR_lat_ComparisonCategory2_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_ComparisonCategory2_max_absES) # no signif diff Benign-Worse / Better-Benign / Better-Benign
...
MR_lat_CueTypeCat1_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_CueTypeCat1_max_absES) # signif intc for auditory only
...
MR_lat_CueTypeCat_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_CueTypeCat_max_absES) # spatial and visual signif diff to auditory
...
MR_lat_ReinforcementCat2_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_ReinforcementCat2_max_absES) # no signif diff R-Null /  R-R / R-P
...
MR_lat_ScalePoint <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ScalePoint) # no signif diff A  to B / C
...
MR_lat_ScalePoint2 <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ScalePoint2) # no signif diff  B to A / C
...
MR_prop_CueTypeCat1 <- rma.mv(yi=d, V=VCV_prop, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_CueTypeCat1) # signif intc for auditory
...
MR_prop_CueTypeCat_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_CueTypeCat_max_absES) # ns diff to auditory
...
MR_prop_CueTypeCat3_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_CueTypeCat3_max_absES) # ns diff to spatial
...
MR_prop_ReinforcementCat2 <- rma.mv(yi=d, V=VCV_prop, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_ReinforcementCat2) # no signif diff R-Null /  R-R / R-P
...
MR_prop_ScalePoint2 <- rma.mv(yi=d, V=VCV_prop, 
                     mod = ~relevel(dat_prop$ScalePoint, ref="B"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_ScalePoint2) # no signif diff  B to A / C
save(MR_prop_ScalePoint2, file = "Rdata/MR_prop_ScalePoint2.Rdata")
...
MR_prop_ScalePoint1_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_ScalePoint1_max_absES) #  signif intc B
save(MR_prop_ScalePoint1_max_absES, file = "Rdata/MR_prop_ScalePoint1_max_absES.Rdata")

MR_prop_ScalePoint_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     mod = ~relevel(dat_prop_max_absES$ScalePoint, ref="A"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_ScalePoint_max_absES) # no signif diff A / B / C
save(MR_prop_ScalePoint_max_absES, file = "Rdata/MR_prop_ScalePoint_max_absES.Rdata")

MR_prop_ScalePoint2_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     mod = ~relevel(dat_prop_max_absES$ScalePoint, ref="B"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_ScalePoint2_max_absES) # no signif diff  B to A / C
save(MR_prop_ScalePoint2_max_absES, file = "Rdata/MR_prop_ScalePoint2_max_absES.Rdata")
```
