...
```{r setup, eval=TRUE, include=FALS}
sessionInfo()
options(scipen=100)
...
```{r load data, eval=TRUE, include=FALS} 
...
table(dat$ScalePoint) #we now have 5 scale points!
### SUBSETS from all data (proportion and latency) by picking only one ES from the curves/tests with >1 scale points [we use the columns that already code these choices):
...
MR_maxES_species <- rma.mv(yi=d, V=VCV_max_ES, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     data = dat_max_ES, method="REML") 
summary(MR_maxES_species) # apis, cow - signif positive
...
- TaskType #DONT USE - ONLY GO/NOGO TASK USED!
...
MR_lat_ReinforcementCat2 <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ReinforcementCat2) # no signif diff R-Null /  R-R / R-P
...
MR_lat_ScalePoint1 <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ScalePoint1) # no signif intcexcept N
...
MR_lat_ScalePoint <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ScalePoint) # no signif diff MID to other
save(MR_lat_ScalePoint, file = "Rdata/MR_lat_ScalePoint.Rdata")

MR_lat_ScalePoint2 <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~relevel(dat_lat$ScalePoint, ref="N"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ScalePoint2) # no signif diff N to other
save(MR_lat_ScalePoint2, file = "Rdata/MR_lat_ScalePoint2.Rdata")

MR_lat_ScalePoint3 <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~relevel(dat_lat$ScalePoint, ref="NN"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ScalePoint3) # no signif diff NN to other
save(MR_lat_ScalePoint3, file = "Rdata/MR_lat_ScalePoint3.Rdata")

MR_lat_ScalePoint4 <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~relevel(dat_lat$ScalePoint, ref="NP"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ScalePoint4) # no signif diff NP to other
save(MR_lat_ScalePoint4, file = "Rdata/MR_lat_ScalePoint4.Rdata")

MR_lat_ScalePoint5 <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~relevel(dat_lat$ScalePoint, ref="P"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ScalePoint5) # no signif diff P to other
save(MR_lat_ScalePoint5, file = "Rdata/MR_lat_ScalePoint5.Rdata")
...
MR_lat_ScalePoint_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     mod = ~relevel(dat_lat_max_absES$ScalePoint, ref="A"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_ScalePoint_max_absES) # no signif diff A  to B / C
save(MR_lat_ScalePoint_max_absES, file = "Rdata/MR_lat_ScalePoint_max_absES.Rdata")

MR_lat_ScalePoint2_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     mod = ~relevel(dat_lat_max_absES$ScalePoint, ref="B"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_ScalePoint2_max_absES) # no signif diff  B to A / C
save(MR_lat_ScalePoint2_max_absES, file = "Rdata/MR_lat_ScalePoint2_max_absES.Rdata")
```
