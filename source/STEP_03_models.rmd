...
sel.table$Model <- c("Reinforcement Category","Task type","Reinforcement Category + Task type","Sex + Task type","Reinforcement Category + Sex","Sex") #manually setting model formulas
