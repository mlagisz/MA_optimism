...
res_regtest #t = 0.0174, df = 457, p = 0.9861
# use: res_regtest$zval res_regtest$dfs res_regtest$pval

#res_ranktest <- ranktest(PB_model) 
#res_ranktest$pval #0.24046
...
# regtest(PB_model, model="lm") #test for funnel plot asymmetry: t = 0.0174, df = 457, p = 0.9861
# ranktest(PB_model) #Kendall's tau = 0.0367, p = 0.2405
