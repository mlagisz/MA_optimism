...
sessionInfo()
options(scipen=100)
pacman::p_load(tidyverse, magrittr, fulltext, rotl, ape, dplyr, tidyr, rotl, fulltext, metafor, car, robumeta, MuMIn, lme4, effects, multicomp)
...
calc.I2(dat$Vd, MA_all_random_VCV_phylo) #78.9% Htotal, 4.5% phylogeny, 0% speciesID
...
MA_all <- rma.mv(yi=d, V=VCV, 
                             ...
                             data = dat, method = "REML") 
summary(MA_all)    
calc.I2(dat$Vd, MA_all) #78.9% Htotal, 4.3% phylogeny
...
#subset by picking ES with the biggest absolute value from each curve (i.e. get the most positive or negatve response available)
...
#subset by picking ES from each curve which has the biggest absolute value in the direction of the mean value of all 3 ES from the curve (i.e. biggest in the overall direction of the overall response) 
...
calc.I2(dat_max_meanES$Vd, MA_maxmeanES) #89% Htotal, 8% phylogeny
...
########################################################
##### Max B ES data subset (dat_MID_ES, k=106) - DO NOT USE (MENTION)
#subset by picking ES from each curve which isin the midpoint (i.e. B) 

```{r MA dat_MID_ES subset} 
...
##subset by picking maximum ES from each curve (i.e. get the most positive=optimistic response available)

#subset by picking ES with the biggest absolute value from each curve (i.e. get the most positive or negatve response available)
dim(dat_max_absES) 
#subset by picking ES from each curve which has the biggest absolute value in the direction of the mean value of all 3 ES from the curve (i.e. biggest in the overall direction of the response)
dim(dat_max_meanES) 
...
```{r MA latency data - max_absES subset} 
######## random-effect model with VCV and phylogeny (Species_Latin)
MA_lat_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                             random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             R = list(Species_Latin = CorMatrix_lat),
                             data = dat_lat_max_absES, method = "REML") 
summary(MA_lat_max_absES)    
calc.I2(dat_lat_max_absES$Vd, MA_lat_max_absES)
save(MA_lat_max_absES, file = "Rdata/MA_lat_max_absES.Rdata")

######## random-effect model with VCV and no phylogeny and no species
MA_lat_max_absES_nophylo <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                             random=list(~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             data = dat_lat_max_absES, method = "REML") 
summary(MA_lat_max_absES_nophylo)    
calc.I2(dat_lat_max_absES$Vd, MA_lat_max_absES_nophylo)
save(MA_lat_max_absES_nophylo, file = "Rdata/MA_lat_max_absES_nophylo.Rdata")
```

```{r MA latency data - max_meanES subset} 
######## random-effect model with VCV and phylogeny (Species_Latin)
MA_lat_max_meanES <- rma.mv(yi=d, V=VCV_lat_max_meanES, 
                             random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             R = list(Species_Latin = CorMatrix_lat),
                             data = dat_lat_max_meanES, method = "REML") 
summary(MA_lat_max_meanES)    
calc.I2(dat_lat_max_meanES$Vd, MA_lat_max_meanES)
save(MA_lat_max_meanES, file = "Rdata/MA_lat_max_meanES.Rdata")

######## random-effect model with VCV and no phylogeny and no species
MA_lat_max_meanES_nophylo <- rma.mv(yi=d, V=VCV_lat_max_meanES, 
                             random=list(~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             data = dat_lat_max_meanES, method = "REML") 
summary(MA_lat_max_meanES_nophylo)    
calc.I2(dat_lat_max_meanES$Vd, MA_lat_max_meanES_nophylo)
save(MA_lat_max_meanES_nophylo, file = "Rdata/MA_lat_max_meanES_nophylo.Rdata")
```

```{r MA latency data - B_ES subset} 
######## random-effect model with VCV and phylogeny (Species_Latin)
MA_lat_MID_ES <- rma.mv(yi=d, V=VCV_lat_MID_ES, 
                             random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             R = list(Species_Latin = CorMatrix_lat),
                             data = dat_lat_MID_ES, method = "REML") 
summary(MA_lat_MID_ES)    
calc.I2(dat_lat_MID_ES$Vd, MA_lat_MID_ES)
save(MA_lat_MID_ES, file = "Rdata/MA_lat_MID_ES.Rdata")

######## random-effect model with VCV and no phylogeny and no species
MA_lat_MID_ES_nophylo <- rma.mv(yi=d, V=VCV_lat_MID_ES, 
                             random=list(~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             data = dat_lat_MID_ES, method = "REML") 
summary(MA_lat_MID_ES_nophylo)    
calc.I2(dat_lat_MID_ES$Vd, MA_lat_MID_ES_nophylo)
save(MA_lat_MID_ES_nophylo, file = "Rdata/MA_lat_MID_ES_nophylo.Rdata")
```

```{r MA latency data - max_meanES subset} 
######## random-effect model with VCV and phylogeny (Species_Latin)
MA_lat_maxES <- rma.mv(yi=d, V=VCV_lat_max_ES, 
                             random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             R = list(Species_Latin = CorMatrix_lat),
                             data = dat_lat_max_ES, method = "REML") 
summary(MA_lat_maxES)    
calc.I2(dat_lat_max_ES$Vd, MA_lat_maxES)
save(MA_lat_maxES, file = "Rdata/MA_lat_maxES.Rdata")

######## random-effect model with VCV and no phylogeny and no species
MA_lat_maxES_nophylo <- rma.mv(yi=d, V=VCV_lat_max_ES, 
                             random=list(~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             data = dat_lat_max_ES, method = "REML") 
summary(MA_lat_maxES_nophylo)    
calc.I2(dat_lat_max_ES$Vd, MA_lat_maxES_nophylo)
save(MA_lat_maxES_nophylo, file = "Rdata/MA_lat_maxES_nophylo.Rdata")
```
...
######## random-effect model with VCV and phylogeny (Species_Latin)
MA_prop_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                             random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             R = list(Species_Latin = CorMatrix_prop),
                             data = dat_prop_max_absES, method = "REML") 
summary(MA_prop_max_absES)    
calc.I2(dat_prop_max_absES$Vd, MA_prop_max_absES)
save(MA_prop_max_absES, file = "Rdata/MA_prop_max_absES.Rdata")

######## random-effect model with VCV and no phylogeny and no species
MA_prop_max_absES_nophylo <- rma.mv(yi=d, V=VCV_prop_max_ES, 
                             random=list(~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             data = dat_prop_max_absES, method = "REML") 
summary(MA_prop_max_absES_nophylo)    
calc.I2(dat_prop_max_absES$Vd, MA_prop_max_absES_nophylo)
save(MA_prop_max_absES_nophylo, file = "Rdata/MA_prop_max_absES_nophylo.Rdata")
```

```{r MA proportion data - max_meanES subset} 
######## random-effect model with VCV and phylogeny (Species_Latin)
MA_prop_max_meanES <- rma.mv(yi=d, V=VCV_prop_max_meanES, 
                             random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             R = list(Species_Latin = CorMatrix_prop),
                             data = dat_prop_max_meanES, method = "REML") 
summary(MA_prop_max_meanES)    
calc.I2(dat_prop_max_meanES$Vd, MA_prop_max_meanES)
save(MA_prop_max_meanES, file = "Rdata/MA_prop_max_meanES.Rdata")

######## random-effect model with VCV and no phylogeny and no species
MA_prop_max_meanES_nophylo <- rma.mv(yi=d, V=VCV_prop_max_meanES, 
                             random=list(~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             data = dat_prop_max_meanES, method = "REML") 
summary(MA_prop_max_meanES_nophylo)    
calc.I2(dat_prop_max_meanES$Vd, MA_prop_max_meanES_nophylo)
save(MA_prop_max_meanES_nophylo, file = "Rdata/MA_prop_max_meanES_nophylo.Rdata")
```

```{r MA proportion data - B_ES subset} 
######## random-effect model with VCV and phylogeny (Species_Latin)
MA_prop_MID_ES <- rma.mv(yi=d, V=VCV_prop_MID_ES, 
                             random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             R = list(Species_Latin = CorMatrix_prop),
                             data = dat_prop_MID_ES, method = "REML") 
summary(MA_prop_MID_ES)    
calc.I2(dat_prop_MID_ES$Vd, MA_prop_MID_ES)
save(MA_prop_MID_ES, file = "Rdata/MA_prop_MID_ES.Rdata")

######## random-effect model with VCV and no phylogeny and no species
MA_prop_MID_ES_nophylo <- rma.mv(yi=d, V=VCV_prop_MID_ES, 
                             random=list(~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             data = dat_prop_MID_ES, method = "REML") 
summary(MA_prop_MID_ES_nophylo)    
calc.I2(dat_prop_MID_ES$Vd, MA_prop_MID_ES_nophylo)
save(MA_prop_MID_ES_nophylo, file = "Rdata/MA_prop_MID_ES_nophylo.Rdata")
```

```{r MA proportion data - max_meanES subset} 
######## random-effect model with VCV and phylogeny (Species_Latin)
MA_prop_maxES <- rma.mv(yi=d, V=VCV_prop_max_ES, 
                             random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             R = list(Species_Latin = CorMatrix_prop),
                             data = dat_prop_max_ES, method = "REML") 
summary(MA_prop_maxES)    
calc.I2(dat_prop_max_ES$Vd, MA_prop_maxES)
save(MA_prop_maxES, file = "Rdata/MA_prop_maxES.Rdata")

######## random-effect model with VCV and no phylogeny and no species
MA_prop_maxES_nophylo <- rma.mv(yi=d, V=VCV_prop_max_ES, 
                             random=list(~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                             data = dat_prop_max_ES, method = "REML") 
summary(MA_prop_maxES_nophylo)    
calc.I2(dat_prop_max_ES$Vd, MA_prop_maxES_nophylo)
save(MA_prop_maxES_nophylo, file = "Rdata/MA_prop_maxES_nophylo.Rdata")
```
...
vif.mer(model) # TaskType has 4.6, CueType 4.1
...
```{r vif - latency data}
model <- lmer(d ~ Sex + Age + Captive_Wild.caught + AffectManipCat + AffectManipTiming + ComparisonCategory + CueTypeCat + FoodDeprived + WithinBetween + Automated + Blind  + ReinforcementCat + ScalePoint + (1|ExperimentID), data = dat_lat)
vif.mer(model) # CueTypeCatvisual 7.6 CueTypeCatspatial 5.9

model <- lmer(d ~ Sex + Age + Captive_Wild.caught + AffectManipCat + AffectManipTiming + ComparisonCategory + CueTypeCat + FoodDeprived +  WithinBetween + Automated + Blind + ScalePoint + (1|ExperimentID), data = dat_lat)
vif.mer(model) # CueTypeCatvisual 7.5 CueTypeCatspatial 5.8
```
...
vif.mer(model) # TaskType has 11.6, ReinforcementCatR-P has 10.3, Captive_Wild.caughtwild-caught has 6.2, CueTypeCatolfactory has 5.8
...
vif.mer(model) # TaskType has 6.6, Captive_Wild.caughtwild-caught has 11.6, CueTypeCatolfactory has 12.4 without ReinforcementCat
```
...
MR_lat_species <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_species) # no sp with clear effect
...
- TaskType #DONT USE - ONLY GO/NO-GO TASK USED!
```{r MR lat data - TaskType, eval=FALSE}
...
MR_lat_sex2 <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~relevel(dat_lat$Sex, ref="male"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_sex2) # ns diff
save(MR_lat_sex2, file = "Rdata/MR_lat_sex2.Rdata")
...
MR_lat_sex2_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     mod = ~relevel(dat_lat_max_absES$Sex, ref="male"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_sex2_max_absES) # ns diff
save(MR_lat_sex2_max_absES, file = "Rdata/MR_lat_sex2_max_absES.Rdata")
```
...
MR_lat_age1 <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_age1) #  signif intc adult only
...
MR_lat_age1_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_age1_max_absES) # signif intc adult only
...
MR_lat_source <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_source) # signif diff captive/wild-caught
...
MR_lat_source_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_source_max_absES) #  signif diff captive/wild-caught
...
MR_lat_AffectManipCat1 <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML")
summary(MR_lat_AffectManipCat1) #  signif intc stress
...
MR_lat_ComparisonCategory <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ComparisonCategory) #  signif diff Benign-Worse / Better-Benign
save(MR_lat_ComparisonCategory, file = "Rdata/MR_lat_ComparisonCategory.Rdata")

MR_lat_ComparisonCategory2 <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~relevel(dat_lat$ComparisonCategory, ref="Better-Benign"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ComparisonCategory2) # signif diff Benign-Worse / Better-Benign 
save(MR_lat_ComparisonCategory2, file = "Rdata/MR_lat_ComparisonCategory2.Rdata")
...
MR_lat_ComparisonCategory1_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_ComparisonCategory1_max_absES) # ns intc 
...
MR_lat_ComparisonCategory2_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     mod = ~relevel(dat_lat_max_absES$ComparisonCategory, ref="Better-Benign"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_ComparisonCategory2_max_absES) # no signif diff Benign-Worse / Better-Benign / Better-Worse
save(MR_lat_ComparisonCategory2_max_absES, file = "Rdata/MR_lat_ComparisonCategory2_max_absES.Rdata")
```
...
MR_lat_CueTypeCat1 <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_CueTypeCat1) # signif intc for spatial
...
MR_lat_CueTypeCat <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_CueTypeCat) #no signif diff
save(MR_lat_CueTypeCat, file = "Rdata/MR_lat_CueTypeCat.Rdata")

# no olfactory level in this data subset
# MR_lat_CueTypeCat2 <- rma.mv(yi=d, V=VCV_lat, 
#                      mod = ~relevel(dat_lat$CueTypeCat, ref="olfactory"), 
#                      random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
#                      R = list(Species_Latin = CorMatrix_lat), 
#                      data = dat_lat, method="REML") 
# summary(MR_lat_CueTypeCat2) # no signif diff to olfactory
# save(MR_lat_CueTypeCat2, file = "Rdata/MR_lat_CueTypeCat2.Rdata")

MR_lat_CueTypeCat3 <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~relevel(dat_lat$CueTypeCat, ref="spatial"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_CueTypeCat3) # ns diff to spatial
save(MR_lat_CueTypeCat3, file = "Rdata/MR_lat_CueTypeCat3.Rdata")

# MR_lat_CueTypeCat4 <- rma.mv(yi=d, V=VCV_lat, 
#                      mod = ~relevel(dat_lat$CueTypeCat, ref="tactile"), 
#                      random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
#                      R = list(Species_Latin = CorMatrix_lat), 
#                      data = dat_lat, method="REML") 
# #summary(MR_lat_CueTypeCat4) # signif diff  tactile - auditory
# #save(MR_lat_CueTypeCat4, file = "Rdata/MR_lat_CueTypeCat4.Rdata")

MR_lat_CueTypeCat5 <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~relevel(dat_lat$CueTypeCat, ref="visual"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_CueTypeCat5) # ns diff to visual
save(MR_lat_CueTypeCat5, file = "Rdata/MR_lat_CueTypeCat5.Rdata")
...
MR_lat_CueTypeCat1_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_CueTypeCat1_max_absES) # no signif intc
...
MR_lat_CueTypeCat_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_CueTypeCat_max_absES) # no signif diff to auditory
save(MR_lat_CueTypeCat_max_absES, file = "Rdata/MR_lat_CueTypeCat_max_absES.Rdata")

# no olfactory level in this data subset
# MR_lat_CueTypeCat2_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
#                      mod = ~relevel(dat_lat_max_absES$CueTypeCat, ref="olfactory"), 
#                      random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
#                      R = list(Species_Latin = CorMatrix_lat), 
#                      data = dat_lat_max_absES, method="REML") 
# summary(MR_lat_CueTypeCat2_max_absES) # no signif diff to olfactory
# save(MR_lat_CueTypeCat2_max_absES, file = "Rdata/MR_lat_CueTypeCat2_max_absES.Rdata")

MR_lat_CueTypeCat3_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     mod = ~relevel(dat_lat_max_absES$CueTypeCat, ref="spatial"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_CueTypeCat3_max_absES) # ns diff to spatial
save(MR_lat_CueTypeCat3_max_absES, file = "Rdata/MR_lat_CueTypeCat3_max_absES.Rdata")

#MR_lat_CueTypeCat4_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
#                     mod = ~relevel(dat_lat_max_absES$CueTypeCat, ref="tactile"), 
#                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
#                     R = list(Species_Latin = CorMatrix_lat), 
#                     data = dat_lat_max_absES, method="REML") 
#summary(MR_lat_CueTypeCat4_max_absES) # no signif diff to tactile
#save(MR_lat_CueTypeCat4_max_absES, file = "Rdata/MR_lat_CueTypeCat4_max_absES.Rdata")

MR_lat_CueTypeCat5_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     mod = ~relevel(dat_lat_max_absES$CueTypeCat, ref="visual"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_CueTypeCat5_max_absES) #  ns diff to visual
save(MR_lat_CueTypeCat5_max_absES, file = "Rdata/MR_lat_CueTypeCat5_max_absES.Rdata")
```
...
MR_lat_FoodDeprived1 <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_FoodDeprived1) #  signif intc yes / no
...
MR_lat_FoodDeprived1_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_FoodDeprived1_max_absES) #  signif intc yes
...
MR_lat_FoodDeprived_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_FoodDeprived_max_absES) # signif diff yes / no
...
MR_lat_WithinBetween1 <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_WithinBetween1) # signif intc within and between
save(MR_lat_WithinBetween1, file = "Rdata/MR_lat_WithinBetween1.Rdata")
...
save(MR_lat_WithinBetween1_max_absES, file = "Rdata/MR_lat_WithinBetween1_max_absES.Rdata")
...
MR_lat_Automated1 <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_Automated1) # no signif intc no
...
MR_lat_Automated1_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_Automated1_max_absES) #  signif intc  no
...
MR_lat_Blind1 <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_Blind1) #  signif intc no
...
MR_lat_Blind1_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_Blind1_max_absES) #  no signif intc
...
MR_lat_ReinforcementCat1 <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ReinforcementCat1) #  signif intc R-P
...
MR_lat_ReinforcementCat <- rma.mv(yi=d, V=VCV_lat, 
                    ...
                    random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ReinforcementCat) # no signif diff R-Null /  R-P
save(MR_lat_ReinforcementCat, file = "Rdata/MR_lat_ReinforcementCat.Rdata")


MR_lat_ReinforcementCat2 <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~relevel(dat_lat$ReinforcementCat, ref="R-P"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ReinforcementCat2) # no signif diff R-Null /  R-P
save(MR_lat_ReinforcementCat2, file = "Rdata/MR_lat_ReinforcementCat2.Rdata")
...
MR_lat_ReinforcementCat1_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_ReinforcementCat1_max_absES) #  ns intc R-P
...
MR_lat_ReinforcementCat_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_ReinforcementCat_max_absES) # no signif diff R-Null / R-P
save(MR_lat_ReinforcementCat_max_absES, file = "Rdata/MR_lat_ReinforcementCat_max_absES.Rdata")

MR_lat_ReinforcementCat2_max_absES <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     mod = ~relevel(dat_lat_max_absES$ReinforcementCat, ref="R-P"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_ReinforcementCat2_max_absES) # no signif diff R-Null /  R-P
save(MR_lat_ReinforcementCat2_max_absES, file = "Rdata/MR_lat_ReinforcementCat2_max_absES.Rdata")
```


- AmbigReinforced - DO NOT USE (only 1 level!)
```{r MR lat data - AmbigReinforced, eval=FALSE}
...
MR_lat_ScalePoint1 <- rma.mv(yi=d, V=VCV_lat, 
                     ...
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ScalePoint1) #  signif intc, except N
save(MR_lat_ScalePoint1, file = "Rdata/MR_lat_ScalePoint1.Rdata")

MR_lat_ScalePoint_MID <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~relevel(dat_lat$ScalePoint, ref="MID"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ScalePoint_MID) # no signif diff MID to other
save(MR_lat_ScalePoint_MID, file = "Rdata/MR_lat_ScalePoint_MID.Rdata")

MR_lat_ScalePoint_N <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~relevel(dat_lat$ScalePoint, ref="N"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ScalePoint_N) # no signif diff N to other
save(MR_lat_ScalePoint_N, file = "Rdata/MR_lat_ScalePoint_N.Rdata")

MR_lat_ScalePoint_NN <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~relevel(dat_lat$ScalePoint, ref="NN"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ScalePoint_NN) # no signif diff NN to other
save(MR_lat_ScalePoint_NN, file = "Rdata/MR_lat_ScalePoint_NN.Rdata")

MR_lat_ScalePoint_NP <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~relevel(dat_lat$ScalePoint, ref="NP"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ScalePoint_NP) # no signif diff NP to other
save(MR_lat_ScalePoint_NP, file = "Rdata/MR_lat_ScalePoint_NP.Rdata")

MR_lat_ScalePoint_P <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~relevel(dat_lat$ScalePoint, ref="P"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_ScalePoint_P) # no signif diff P to other
save(MR_lat_ScalePoint_P, file = "Rdata/MR_lat_ScalePoint_P.Rdata")

#max_absES

MR_lat_ScalePoint_max_absES1 <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     mod = ~ScalePoint -1, 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_ScalePoint_max_absES1) # only N signif intc 
save(MR_lat_ScalePoint_max_absES1, file = "Rdata/MR_lat_ScalePoint_max_absES1.Rdata")

MR_lat_ScalePoint_max_absES_MID <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     mod = ~relevel(dat_lat_max_absES$ScalePoint, ref="MID"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_ScalePoint_max_absES_MID) # no signif diff MID  to other
save(MR_lat_ScalePoint_max_absES_MID, file = "Rdata/MR_lat_ScalePoint_max_absES_MID.Rdata")

MR_lat_ScalePoint_max_absES_MID_N <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     mod = ~relevel(dat_lat_max_absES$ScalePoint, ref="N"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_ScalePoint_max_absES_MID_N) # N signif diff to NN only
save(MR_lat_ScalePoint_max_absES_MID_N, file = "Rdata/MR_lat_ScalePoint_max_absES_MID_N.Rdata")

MR_lat_ScalePoint_max_absES_MID_NN <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     mod = ~relevel(dat_lat_max_absES$ScalePoint, ref="NN"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_ScalePoint_max_absES_MID_NN) # N signif diff to NN only
save(MR_lat_ScalePoint_max_absES_MID_NN, file = "Rdata/MR_lat_ScalePoint_max_absES_MID_NN.Rdata")

MR_lat_ScalePoint_max_absES_MID_NP <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     mod = ~relevel(dat_lat_max_absES$ScalePoint, ref="NP"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_ScalePoint_max_absES_MID_NP) # N signif diff to NN only
save(MR_lat_ScalePoint_max_absES_MID_NP, file = "Rdata/MR_lat_ScalePoint_max_absES_MID_NP.Rdata")

MR_lat_ScalePoint_max_absES_MID_P <- rma.mv(yi=d, V=VCV_lat_max_absES, 
                     mod = ~relevel(dat_lat_max_absES$ScalePoint, ref="P"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat),
                     data = dat_lat_max_absES, method="REML") 
summary(MR_lat_ScalePoint_max_absES_MID_P) # N signif diff to NN only
save(MR_lat_ScalePoint_max_absES_MID_P, file = "Rdata/MR_lat_ScalePoint_max_absES_MID_P.Rdata")
...
MR_lat_Full_0 <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~Sex + Age + Captive_Wild.caught + AffectManipCat + AffectManipTiming + ComparisonCategory + CueTypeCat + FoodDeprived  + WithinBetween + Automated + Blind  + ReinforcementCat + ScalePoint, 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_Full_0) # Captive_Wild.caughtwild-caught negative diff, ComparisonCategoryBetter-Worse  diff from ComparisonCategoryBenign-Worse in femalesa at MID?
save(MR_lat_Full_0, file = "Rdata/MR_lat_Full_0.Rdata")


#how to simplify the model?
MR_lat_Full_1 <- rma.mv(yi=d, V=VCV_lat, 
                     mod = ~Captive_Wild.caught + ComparisonCategory, 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID, ~1|ScalePoint),
                     R = list(Species_Latin = CorMatrix_lat), 
                     data = dat_lat, method="REML") 
summary(MR_lat_Full_1) #
...
MR_prop_TaskType1_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_TaskType1_max_absES) # not signif intc active choice, and go/no-go
...
MR_prop_sex <- rma.mv(yi=d, V=VCV_prop, 
                     mod = ~relevel(dat_prop$Sex, ref="female"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
...
MR_prop_sex2 <- rma.mv(yi=d, V=VCV_prop, 
                     mod = ~relevel(dat_prop$Sex, ref="male"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_sex2) # ns diff
save(MR_prop_sex2, file = "Rdata/MR_prop_sex2.Rdata")
...
MR_prop_sex_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     mod = ~relevel(dat_prop_max_absES$Sex, ref="female"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
...
MR_prop_sex2_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     mod = ~relevel(dat_prop_max_absES$Sex, ref="male"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_sex2_max_absES) # ns diff 
save(MR_prop_sex2_max_absES, file = "Rdata/MR_prop_sex2_max_absES.Rdata")
```
...
MR_prop_age1_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_age1_max_absES) # signif intc juvenile only
...
MR_prop_source1_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_source1_max_absES) # no signif intc
...
MR_prop_AffectManipCat1 <- rma.mv(yi=d, V=VCV_prop, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_AffectManipCat1) #  signif intc stress
...
MR_prop_AffectManipTiming1_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_AffectManipTiming1_max_absES) # no signif intc 
...
MR_prop_ComparisonCategory2 <- rma.mv(yi=d, V=VCV_prop, 
                     mod = ~relevel(dat_prop$ComparisonCategory, ref="Better-Benign"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_ComparisonCategory2) # no signif diff Benign-Worse / Better-Benign / Better-Worse
save(MR_prop_ComparisonCategory2, file = "Rdata/MR_prop_ComparisonCategory2.Rdata")
...
MR_prop_ComparisonCategory1_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_ComparisonCategory1_max_absES) #  no signif intc
...
MR_prop_ComparisonCategory2_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     mod = ~relevel(dat_prop_max_absES$ComparisonCategory, ref="Better-Benign"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_ComparisonCategory2_max_absES) # no signif diff Benign-Worse / Better-Benign / Better-Worse
save(MR_prop_ComparisonCategory2_max_absES, file = "Rdata/MR_prop_ComparisonCategory2_max_absES.Rdata")
...
MR_prop_CueTypeCat1 <- rma.mv(yi=d, V=VCV_prop, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_CueTypeCat1) # signif intc for auditory, tactile
...
MR_prop_CueTypeCat <- rma.mv(yi=d, V=VCV_prop, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_CueTypeCat) #ns diff
save(MR_prop_CueTypeCat, file = "Rdata/MR_prop_CueTypeCat.Rdata")

MR_prop_CueTypeCat2 <- rma.mv(yi=d, V=VCV_prop, 
                      mod = ~relevel(dat_prop$CueTypeCat, ref="olfactory"), 
                      random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                      R = list(Species_Latin = CorMatrix_prop), 
                      data = dat_prop, method="REML") 
summary(MR_prop_CueTypeCat2) # no signif diff to olfactory
save(MR_prop_CueTypeCat2, file = "Rdata/MR_prop_CueTypeCat2.Rdata")

MR_prop_CueTypeCat3 <- rma.mv(yi=d, V=VCV_prop, 
                     mod = ~relevel(dat_prop$CueTypeCat, ref="spatial"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_CueTypeCat3) # ns diff to spatial
save(MR_prop_CueTypeCat3, file = "Rdata/MR_prop_CueTypeCat3.Rdata")

MR_prop_CueTypeCat4 <- rma.mv(yi=d, V=VCV_prop, 
                     mod = ~relevel(dat_prop$CueTypeCat, ref="tactile"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_CueTypeCat4) # ns diff to tactile
save(MR_prop_CueTypeCat4, file = "Rdata/MR_prop_CueTypeCat4.Rdata")

MR_prop_CueTypeCat5 <- rma.mv(yi=d, V=VCV_prop, 
                     mod = ~relevel(dat_prop$CueTypeCat, ref="visual"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_CueTypeCat5) # ns diff to visual
save(MR_prop_CueTypeCat5, file = "Rdata/MR_prop_CueTypeCat5.Rdata")
...
MR_prop_CueTypeCat1_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_CueTypeCat1_max_absES) # signif intc for auditory
...
MR_prop_CueTypeCat_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_CueTypeCat_max_absES) # signif diff to auditory - spatal
save(MR_prop_CueTypeCat_max_absES, file = "Rdata/MR_prop_CueTypeCat_max_absES.Rdata")

MR_prop_CueTypeCat2_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                      mod = ~relevel(dat_prop_max_absES$CueTypeCat, ref="olfactory"), 
                      random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                      R = list(Species_Latin = CorMatrix_prop), 
                      data = dat_prop_max_absES, method="REML") 
summary(MR_prop_CueTypeCat2_max_absES) # no signif diff to olfactory
save(MR_prop_CueTypeCat2_max_absES, file = "Rdata/MR_prop_CueTypeCat2_max_absES.Rdata")

MR_prop_CueTypeCat3_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     mod = ~relevel(dat_prop_max_absES$CueTypeCat, ref="spatial"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_CueTypeCat3_max_absES) # sifgnif diff to spatial - auditory
save(MR_prop_CueTypeCat3_max_absES, file = "Rdata/MR_prop_CueTypeCat3_max_absES.Rdata")

MR_prop_CueTypeCat4_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     mod = ~relevel(dat_prop_max_absES$CueTypeCat, ref="tactile"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_CueTypeCat4_max_absES) # no signif diff to tactile
save(MR_prop_CueTypeCat4_max_absES, file = "Rdata/MR_prop_CueTypeCat4_max_absES.Rdata")

MR_prop_CueTypeCat5_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     mod = ~relevel(dat_prop_max_absES$CueTypeCat, ref="visual"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_CueTypeCat5_max_absES) #  ns diff to visual
save(MR_prop_CueTypeCat5_max_absES, file = "Rdata/MR_prop_CueTypeCat5_max_absES.Rdata")
```
...
MR_prop_FoodDeprived1_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_FoodDeprived1_max_absES) #  signif intc yes
...
save(MR_prop_WithinBetween1, file = "Rdata/MR_prop_WithinBetween1.Rdata")
...
MR_prop_WithinBetween1_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_WithinBetween1_max_absES) # signif intc within
save(MR_prop_WithinBetween1_max_absES, file = "Rdata/MR_prop_WithinBetween1_max_absES.Rdata")
...
MR_prop_ReinforcementCat1 <- rma.mv(yi=d, V=VCV_prop, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_ReinforcementCat1) # R-R signif intc 
...
MR_prop_ReinforcementCat <- rma.mv(yi=d, V=VCV_prop, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_ReinforcementCat) #  signif diff R-Null vs  R-R / R-P
save(MR_prop_ReinforcementCat, file = "Rdata/MR_prop_ReinforcementCat.Rdata")

MR_prop_ReinforcementCat2 <- rma.mv(yi=d, V=VCV_prop, 
                     mod = ~relevel(dat_prop$ReinforcementCat, ref="R-P"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_ReinforcementCat2) #  signif diff R-P vs R-Null
save(MR_prop_ReinforcementCat2, file = "Rdata/MR_prop_ReinforcementCat2.Rdata")
...
MR_prop_ReinforcementCat1_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_ReinforcementCat1_max_absES) #  R-P signif intc 
...
MR_prop_ReinforcementCat_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_ReinforcementCat_max_absES) #  no signif diff 
save(MR_prop_ReinforcementCat_max_absES, file = "Rdata/MR_prop_ReinforcementCat_max_absES.Rdata")

MR_prop_ReinforcementCat2_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     mod = ~relevel(dat_prop_max_absES$ReinforcementCat, ref="R-P"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_ReinforcementCat2_max_absES) # no signif diff R-Null /  R-R / R-P
save(MR_prop_ReinforcementCat2_max_absES, file = "Rdata/MR_prop_ReinforcementCat2_max_absES.Rdata")
```
...
MR_prop_AmbigReinforced1_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_AmbigReinforced1_max_absES) #  signif intc  no
...
MR_prop_ScalePoint1 <- rma.mv(yi=d, V=VCV_prop, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_ScalePoint1) # no signif intc
save(MR_prop_ScalePoint1, file = "Rdata/MR_prop_ScalePoint1.Rdata")

MR_prop_ScalePoint_MID <- rma.mv(yi=d, V=VCV_prop, 
                     mod = ~relevel(dat_prop$ScalePoint, ref="MID"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_ScalePoint_MID) #  signif diff MID vs P
save(MR_prop_ScalePoint_MID, file = "Rdata/MR_prop_ScalePoint_MID.Rdata")

MR_prop_ScalePoint_N <- rma.mv(yi=d, V=VCV_prop, 
                     mod = ~relevel(dat_prop$ScalePoint, ref="N"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_ScalePoint_N) # no signif diff
save(MR_prop_ScalePoint_N, file = "Rdata/MR_prop_ScalePoint_N.Rdata")

MR_prop_ScalePoint_NN <- rma.mv(yi=d, V=VCV_prop, 
                     mod = ~relevel(dat_prop$ScalePoint, ref="NN"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_ScalePoint_NN) #  signif diff N vs P
save(MR_prop_ScalePoint_NN, file = "Rdata/MR_prop_ScalePoint_NN.Rdata")

MR_prop_ScalePoint_NP <- rma.mv(yi=d, V=VCV_prop, 
                     mod = ~relevel(dat_prop$ScalePoint, ref="NP"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_ScalePoint_NP) # no signif diff
save(MR_prop_ScalePoint_NP, file = "Rdata/MR_prop_ScalePoint_NP.Rdata")

MR_prop_ScalePoint_P <- rma.mv(yi=d, V=VCV_prop, 
                     mod = ~relevel(dat_prop$ScalePoint, ref="P"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop, method="REML") 
summary(MR_prop_ScalePoint_P) #  signif P vs MID and NN
save(MR_prop_ScalePoint_P, file = "Rdata/MR_prop_ScalePoint_P.Rdata")

#max_absES

MR_prop_ScalePoint_max_absES_1 <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     mod = ~ScalePoint -1, 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_ScalePoint_max_absES_1) #  signif intc MID and NN
save(MR_prop_ScalePoint_max_absES_1, file = "Rdata/MR_prop_ScalePoint1_max_absES_1.Rdata")

MR_prop_ScalePoint_max_absES_MID <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     mod = ~relevel(dat_prop_max_absES$ScalePoint, ref="MID"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_ScalePoint_max_absES_MID) #  signif diff MID vs N
save(MR_prop_ScalePoint_max_absES_MID, file = "Rdata/MR_prop_ScalePoint_max_absES_MID.Rdata")

MR_prop_ScalePoint_max_absES_N <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     mod = ~relevel(dat_prop_max_absES$ScalePoint, ref="N"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_ScalePoint_max_absES_N) #  signif diff N vs  MID and NN
save(MR_prop_ScalePoint_max_absES_N, file = "Rdata/MR_prop_ScalePoint_max_absES_N.Rdata")

MR_prop_ScalePoint_max_absES_NN <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     mod = ~relevel(dat_prop_max_absES$ScalePoint, ref="NN"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_ScalePoint_max_absES_NN) #  signif diff NN vs N
save(MR_prop_ScalePoint_max_absES_NN, file = "Rdata/MR_prop_ScalePoint_max_absES_NN.Rdata")

MR_prop_ScalePoint_max_absES_NP <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     mod = ~relevel(dat_prop_max_absES$ScalePoint, ref="NP"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_ScalePoint_max_absES_NP) # no signif diff  
save(MR_prop_ScalePoint_max_absES_NP, file = "Rdata/MR_prop_ScalePoint_max_absES_N.Rdata")

MR_prop_ScalePoint_max_absES_P <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     mod = ~relevel(dat_prop_max_absES$ScalePoint, ref="P"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_ScalePoint_max_absES_P) # no signif diff 
save(MR_prop_ScalePoint_max_absES_P, file = "Rdata/MR_prop_ScalePoint_max_absES_P.Rdata")
```
...
MR_prop_Full_0_max_absES <- rma.mv(yi=d, V=VCV_prop_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_prop), 
                     data = dat_prop_max_absES, method="REML") 
summary(MR_prop_Full_0_max_absES) #signif WithinBetweenwithin, ScalePointN 
save(MR_prop_Full_0_max_absES, file = "Rdata/RdataMR_prop_Full_0_max_absES.Rdata")

```


```{r MR prop data - full model selection, eval=FALSE, include=FLASE }
...
```{r dredge prop, eval=FALSE, include = FALSE}
# using dredge
...
#write.table(sub_meta_AICc, "Rdata/AICc table prop.csv", sep = ",", row.names = F)
...
# candidate.models = dredge(full.model) # DOES NOT WORK
...
# run model averaging
avg.model <- model.avg(candidate.models)
summary(avg.model)
...
full.model3 <- updated.rma.mv(yi=d, V=VCV_prop, 
                     ...
                     random=list(~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     data = dat_prop, method="REML")
summary(full.model3) #only R-null vs R-R signif
```
...
MR_all_CueTypeCat5_max_absES <- rma.mv(yi=d, V=VCV_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     data = dat_max_absES, method="REML") 
summary(MR_all_CueTypeCat5_max_absES) # auditory signif diff to visual
...
MR_all_ScalePoint1_max_absES <- rma.mv(yi=d, V=VCV_max_absES, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     data = dat_max_absES, method="REML") 
summary(MR_all_ScalePoint1_max_absES) # no signif intc A / B 
save(MR_all_ScalePoint1_max_absES, file = "Rdata/MR_all_ScalePoint1_max_absES.Rdata")

MR_all_ScalePoint_max_absES <- rma.mv(yi=d, V=VCV_max_absES, 
                     mod = ~relevel(dat_max_absES$ScalePoint, ref="A"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_all), 
                     data = dat_max_absES, method="REML") 
summary(MR_all_ScalePoint_max_absES) # no signif diff A / B / C
save(MR_all_ScalePoint_max_absES, file = "Rdata/MR_all_ScalePoint_max_absES.Rdata")

MR_all_ScalePoint2_max_absES <- rma.mv(yi=d, V=VCV_max_absES, 
                     mod = ~relevel(dat_max_absES$ScalePoint, ref="B"), 
                     random=list(~1|Species_Latin, ~1|ArticleID, ~1|ExperimentID, ~1|EffectID),
                     R = list(Species_Latin = CorMatrix_all), 
                     data = dat_max_absES, method="REML") 
summary(MR_all_ScalePoint2_max_absES) # no signif diff A / B / C
save(MR_all_ScalePoint2_max_absES, file = "Rdata/MR_all_ScalePoint2_max_absES.Rdata")
```
...
```{r MR all data - MeasureType*TaskType, eval=FALSE, include=FALSE}

table(dat$MeasureType, dat$TaskType) #latency has only go/no-go, proportion has both  go/no-go and active choice - interaction cannot be assessed! - these models are evaluated as additive models
...
MR_all_MeasureType_TaskType1 <- rma.mv(yi=d, V=VCV, 
                     ...
                     R = list(Species_Latin = CorMatrix_all), 
                     data = dat, method="REML") 
summary(MR_all_MeasureType_TaskType1) # all signif intc
...
```{r MR dat_max_ES data - MeasureType*TaskType, eval=FALSE, include=FALSE}
...
```{r MR dat_max_absES data - MeasureType*TaskType, eval=FALSE, include=FALSE}
...
```{r MR dat_max_meanES data - MeasureType*TaskType, eval=FALSE, include=FALSE}
...
```{r MR all data - MeasureType*TaskType - plots, eval=FALSE, include=FALSE}
library(nlme)
library(effects)
library(ggplot2)
library(psych)
...
- Full Models
```{r MR all data - Full models, eval=FALSE, include=FALSE}
...
```{r preliminary funnel plot, eval=FALSE, include=FALSE}
### PLOT - funnel plot
...
regtest(PB_model, model="lm") #test for funnel plot asymmetry: t = 0.5683, df = 457, p = 0.5701
ranktest(PB_model) #endall's tau = 0.0575, p = NA
```
...
robustml_m <- rma.mv(yi = d, V = Vd, W = 1/dat$Vd, random = list(~1|ArticleID, ~1|EffectID), method = "REML", data = dat)
summary(robustml_m) #M 0.1778 SE 0.0786  CI  0.0238  0.3318  **
```
...
#### OTHER
```{r test contrasts, eval=FALSE, include=FALSE}
library(multcomp)
...
par(mfcol=c(1,1)) 
par(mar=c(4,4,2,1))
plot(dat$d, sqrt(1/dat$Vd), xlim=c(-7.5,7.5), xlab = "Effect size [Hg]", ylab="Precision [1/SE]", main="")
abline(v=0,lty=3)
#dev.off()
```
...
# Trim and fill
TF <- trimfill(PB_model)
TF #Estimated number of missing studies on the left side: 51 (SE = 13.7)
funnel(TF)
# Egger's regression test
regtest(PB_model, model="lm") #test for funnel plot asymmetry: t = 0.5683, df = 457, p = 0.5701
...
funnel(TF, xlim=c(-3,3), xlab = "effect size [Hg]", ylab="Standard Error [SE]",
       back="white", shade="lightgray", bg="red", main="B")
abline(v=0,lty=3)
plot(Residuals, Precision, xlim=c(-3,3), ylim=c(0,10), xlab = "Residuals", ylab="Precision [1/SE]", frame.plot=FALSE, main="C")
abline(v=0,lty=3)
#dev.off()
```
