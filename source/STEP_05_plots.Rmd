...
p1 <- orchard_plot(MA_all, xlab = "", transfm = "none", alpha = 0.3) + scale_x_continuous(breaks = seq(-4, 9, by = 1)) + scale_y_discrete(labels = c(Intrcpt = "Overall"))  + scale_fill_manual(values = "grey") + scale_colour_manual(values = "grey") + theme(legend.position = "none") + ggtitle("a.  All data")  #"All data"

p2 <- orchard_plot(MA_amb, xlab = "", transfm = "none", alpha = 0.3) +
scale_x_continuous(breaks = seq(-4, 9, by = 1)) + scale_y_discrete(labels = c(Intrcpt = "Overall")) + scale_fill_manual(values = "grey") + scale_colour_manual(values = "grey") + theme(legend.position = "none") + ggtitle("b.  Ambiguous cues data") #"Ambiguous cues data"

p3 <- orchard_plot(MA_MID_ES, xlab = "", transfm = "none", alpha = 0.3) +
scale_x_continuous(breaks = seq(-4, 9, by = 1)) + scale_y_discrete(labels = c(Intrcpt = "Overall")) + scale_fill_manual(values = "grey") + scale_colour_manual(values = "grey") + theme(legend.position = "none") + ggtitle("c.  Mid-ambiguous cues data") #"Mid-ambiguous cues data"

p4 <- orchard_plot(MA_maxabsES, xlab = "", transfm = "none", alpha = 0.3) +
scale_x_continuous(breaks = seq(-4, 9, by = 1)) + scale_y_discrete(labels = c(Intrcpt = "Overall")) + scale_fill_manual(values = "grey") + scale_colour_manual(values = "grey") + theme(legend.position = "none") + ggtitle("d.  Maximum absolute response data") # "Maximum absolute response data"

p5 <- orchard_plot(MA_maxmeanES, xlab = "", transfm = "none", alpha = 0.3) +
scale_x_continuous(breaks = seq(-4, 9, by = 1)) + scale_y_discrete(labels = c(Intrcpt = "Overall")) + scale_fill_manual(values = "grey") + scale_colour_manual(values = "grey") + theme(legend.position = "none") + ggtitle("e.  Maximum response in dominant direction data") + labs(x = "Effect size [Hedges' g]") #"Maximum response in dominant direction data"
...
pdf(file="plots/Figure_S4_funnels.pdf",width=8,height=4,family="sans",pointsize=10)
