...
xlim(-4,9) +  scale_y_discrete(labels = c("Active choice", "Go/no-go"))  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("b.  Task type")

p4 <- orchard_plot(MR_all_CueTypeCat1, mod = "Cue Type", xlab = "", transfm = "none", alpha = 0.25, angle = 0) +
xlim(-4,9) +  scale_y_discrete(labels = c("Auditory", "Olfactory", "Spatial", "Tactile", "Visulal"))  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("c.  Cue type")

p5 <- orchard_plot(MR_all_ReinforcementCat1, mod = "Reinforcement scheme", xlab = "", transfm = "none", alpha = 0.25, angle = 0) +
xlim(-4,9) +  scale_y_discrete(labels = c("Reward vs. Null", "Reward vs. Punishement", "Reward vs. smaller Reward"))  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("d.  Reinforcement scheme") 

#load(file = "./Rdata/MR_all_ScalePoint1ord.Rdata")
#p8 <- orchard_plot(MR_all_ScalePoint1ord, mod = "Cue location", xlab = "", transfm = "none", alpha = 0.25, angle = 0) + xlim(-4,9) +  scale_y_discrete(labels = c("N", "NN", "MID", "NP", "P"))  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("e.  Cue type/location") #ordering does not work! (only labels get changed, but in wrong order)
#p8 <- orchard_plot(MR_all_ScalePoint1ord, mod = "Cue location", xlab = "", transfm = "none", alpha = 0.25, angle = 0) + xlim(-4,9) +  scale_y_discrete()  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("e.  Cue type/location") #ordering does not work!
...
xlim(-4,9) + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("e.  Cue type/location") 

p1 / p3 / p4 / p5 / p8

ggsave("plots/Figure6_Rplot.pdf", width = 16, height = 16, units = "cm", dpi = 300, scale=2)

#+ theme(legend.position = c(0.6, 1), legend.justification = c(0, 1), legend.key.size = unit(1, "mm")) + theme(legend.direction = "horizontal", legend.title = element_text(size = 8), legend.text = element_text(size = 8))
```


### Figure S1. MR models - univariate models for moderator that were statistically non-significant 

```{r MR - orchard plot nonsignif moderators, eval=TRUE, include=FALSE}

p2 <- orchard_plot(MR_all_MeasureType1, mod = "Measurement type", xlab = "", transfm = "none", alpha = 0.25, angle = 0) +
xlim(-4,9) + scale_y_discrete(labels = c("Latency", "Proportion"))  + scale_fill_manual(values = rep("grey",2)) + scale_colour_manual(values = rep("grey",2)) + theme(legend.position = "none") + ggtitle("a.  Measurement type")

p6 <- orchard_plot(MR_all_AmbigReinforced1, mod = "Ambiguous cue reinforcement scheme", xlab = "", transfm = "none", alpha = 0.25, angle = 0) +
xlim(-4,9) +  scale_y_discrete(labels = c("No", "Yes"))  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("b.  Ambiguous cue reinforced") 

p7 <- orchard_plot(MR_all_WithinBetween1, mod = "Study design", xlab = "", transfm = "none", alpha = 0.25, angle = 0) +
xlim(-4,9) +  scale_y_discrete(labels = c("Between", "Within"))  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("c.  Within or between-individual study design") 

p9 <- orchard_plot(MR_all_source1, mod = "Source", xlab = "", transfm = "none", alpha = 0.25, angle = 0) +
xlim(-4,9) +  scale_y_discrete(labels = c("Captive", "Wild-caught"))  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("d.  Source of animals") 

p10 <- orchard_plot(MR_all_age1, mod = "Age", xlab = "", transfm = "none", alpha = 0.25, angle = 0) +
xlim(-4,9) +  scale_y_discrete(labels = c("Adult", "Juvenile"))  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("e.  Age class of animals") 

p11 <- orchard_plot(MR_all_AffectManipCat1, mod = "AffectManipCat", xlab = "", transfm = "none", alpha = 0.25, angle = 0) +
xlim(-4,9) +  scale_y_discrete(labels = c("Enrichment", "Stress"))  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("f.  Affect manipulation type") 

p12 <- orchard_plot(MR_all_AffectManipTiming1, mod = "AffectManipTiming", xlab = "", transfm = "none", alpha = 0.25, angle = 0) +
xlim(-4,9) +  scale_y_discrete(labels = c("Just before/during", "Long-term"))  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("g.  Affect manipulation  timing") 

p13 <- orchard_plot(MR_all_ComparisonCategory1, mod = "ComparisonCategory", xlab = "", transfm = "none", alpha = 0.25, angle = 0) +
xlim(-4,9) +  scale_y_discrete(labels = c("Benign-Worse", "Better-Benign", "Better-Worse"))  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("h.  Treatment comparison type") 

p14 <- orchard_plot(MR_all_FoodDeprived1, mod = "FoodDeprived", xlab = "", transfm = "none", alpha = 0.25, angle = 0) +
xlim(-4,9) +  scale_y_discrete(labels = c("No", "Yes"))  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("i.  Testing food deprived animals") 

p15 <- orchard_plot(MR_all_Automated1, mod = "Automated", xlab = "", transfm = "none", alpha = 0.25, angle = 0) +
xlim(-4,9) +  scale_y_discrete(labels = c("No", "Yes"))  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("j.  Automated behaviour measurements") 

p16 <- orchard_plot(MR_all_Blind1, mod = "Blind", xlab = "", transfm = "none", alpha = 0.25, angle = 0) +
xlim(-4,9) +  scale_y_discrete(labels = c("No", "Yes"))  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("k.  Blinded behaviour measurements")
...
ggsave("plots/FigureS1_Rplot.pdf", width = 16, height = 21, units = "cm", dpi = 300, scale=2.5)
