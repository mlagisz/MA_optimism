...
p1 <- orchard_plot(MA_all, xlab = "", transfm = "none", alpha = 0.25) +
...
p2 <- orchard_plot(MA_amb, xlab = "", transfm = "none", alpha = 0.25) +
...
p3 <- orchard_plot(MA_MID_ES, xlab = "", transfm = "none", alpha = 0.25) +
...
p4 <- orchard_plot(MA_maxabsES, xlab = "", transfm = "none", alpha = 0.25) +
...
p5 <- orchard_plot(MA_maxmeanES, xlab = "", transfm = "none", alpha = 0.25) +
...
ggsave("plots/Figure4_Rplot.pdf", width = 8, height = 18, units = "cm", dpi = 300, scale=2)
