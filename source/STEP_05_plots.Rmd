...
p8 <- orchard_plot(MR_all_ScalePoint1ord, mod = "Cue location", xlab = "", transfm = "none", alpha = 0.25, angle = 0) +
xlim(-4,9) +  scale_y_discrete(labels = c("N", "NN", "MID", "NP", "P"))  + scale_fill_manual(values = rep("grey",5)) + scale_colour_manual(values = rep("grey",5)) + theme(legend.position = "none") + ggtitle("e.  Cue type/location") #ordering does not work!


#tests on ordering the factor
#p8 <- orchard_plot(MR_all_ScalePoint1ord, mod = "Cue location", xlab = "", transfm = "none", alpha = 0.25, angle = 0) +
...
#p8$data$name <- factor(p8$data$name, labels = p8$data$name)
...
#heights = c(3, 2, 2, 5, 3, 2, 2, 5, 2, 2, 2, 2, 3, 2, 2)
p6 / p7 /p9 / p10 / p11 / p12/ p13 / p14 / p15 / p16

ggsave("plots/FigureS1_Rplot.pdf", width = 16, height = 19, units = "cm", dpi = 300, scale=2)
